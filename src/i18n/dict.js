...
export const en = {
  ...
  "mind.tapAxis": "Tap a circuit to see the markers behind it",
...
export const ko = {
  ...
  "brain.amygdala": "편도체 — 재지만 쓰이지 않음",
  "brain.hippocampus": "해마 — 재지 않음",
  "brain.belowNeck": "목 아래",
  "day.wake": "기상",
  "day.dim": "멜라토닌 시작",
  "day.legend": "채운 곡선: 코르티솔 · 윤곽선: 멜라토닌",
  "scale.recovery.base":
  ...
  "mind.tapAxis": "회로를 눌러 근거 수치를 확인하세요",
